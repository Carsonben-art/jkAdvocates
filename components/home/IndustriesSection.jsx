...
const IndustriesSection = () => {
  ...
  useEffect(() => {
    controls.start({
      x: ["0%", "-50%"], // Move by half since content is duplicated
      transition: {
        ease: "linear",
        repeat: Infinity,
        duration: 15, // Adjusted for faster scrolling
      },
    });
  }, [controls]);
  ...
  return (
    <section className={styles.industriesSection}>
      ...
      <h1 className={styles.heading}>
        Comprehensive Legal Solutions: <br /> Protecting Your Business, Assets, and Rights
      </h1>
        ...
        <motion.div className={styles.slider} animate={controls}>
          ...
          {[...industries, ...industries].map((industry, index) => (
            <div key={index} className={styles.industryCard}>
              <Image src={industry.img} alt={industry.title} width={350} height={200} className={styles.image} />
